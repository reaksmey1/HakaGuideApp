...
export const SHOW_BOOKED_ACTIVITIES = 'show_booked_activities';
export const SHOW_BOOKED_ACTIVITIES_SUCCESS = 'show_activities_success';
export const SHOW_BOOKED_ACTIVITIES_FAIL = 'show_activities_fail';
export const ITINERARIES_FETCH_SUCCESS = 'itineraries_fetch_success';